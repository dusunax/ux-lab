...
| 5 | UX-1 | 데스크톱 키보드 단축키 — 숫자키로 답 선택, 답변 후 Enter/Space로 "다음 문제" / "결과 보기" 트리거 |
...
| 9 | CSV-SAMPLE-1 | 내장 샘플 데이터 — 모바일앱 프로그래밍·데이터 정보처리 샘플 5종 로드 버튼 제공 |
...
**UX (키보드·시간)**
- [x] 데스크톱에서 보기를 선택한 상태로 Enter 또는 Space를 누르면 "다음 문제" 또는 "결과 보기"가 실행된다
- [x] 데스크톱에서 보기를 선택하지 않은 상태에서는 Enter 또는 Space가 무시된다
- [x] 데스크톱에서 숫자키 입력으로 현재 문제의 선택지를 고를 수 있다
- [x] 모바일 화면에서는 숫자키·Enter·Space 단축키와 숨김 입력 캐처를 비활성화해 소프트 키보드가 화면을 가리지 않는다
- [x] 모바일 화면에서 파일 업로드 후 시작하기 버튼이 하단 sticky 액션으로 보인다
- [x] 모바일 화면에서 정답 선택 후 해설과 다음 문제 버튼이 하단 sticky 영역으로 보인다
...
- [x] `mobile-programming-120.csv` 샘플을 버튼으로 불러올 수 있다
- [x] `data-processing-100.csv` 샘플을 버튼으로 불러올 수 있다
- [x] `data-info-processing-77.csv` 샘플을 버튼으로 불러올 수 있다
- [x] `data-info-processing-core-25.csv` 샘플을 버튼으로 불러올 수 있다
...
- [x] 데스크톱 키보드 단축키 구현 — 숫자키 답 선택, 답변 후 Enter/Space 이동, 미선택 시 무시 — UX-1
- [x] 모바일 키보드 단축키 비활성화 및 소프트 키보드 가림 방지 — UX-1
- [x] 모바일 파일 업로드 후 시작 버튼 visibility 개선 — UX-1
- [x] 모바일 답변 후 해설/다음 버튼 visibility 개선 — UX-1
...
- [x] 샘플 CSV 5종 로드 버튼 및 선택 상태 표시 구현 — CSV-SAMPLE-1
