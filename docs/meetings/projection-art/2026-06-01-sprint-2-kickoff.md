...
- [x] 웹캠 권한 요청 UI 구현 + 웹캠 미사용/거부 시 마우스 폴백 자동 전환 로직 구현 (`WebcamPermission`)
...
- [ ] 수용 기준 전체 항목 검증 (Demo D 동작, 폴백 모드, 어댑터 적용) ← 실기기 확인 필요
- [ ] 모션 입력 지연 검증 — MediaPipe 추론 결과가 비주얼 반응에 반영되는 지연 시간 측정 ← 실기기 확인 필요
