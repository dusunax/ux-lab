...
| 역할 | 에이전트 | 쓰기 허용 경로 | 읽기 |
|------|---------|--------------|------|
| **FE** | Avery | `apps/**/components/**`, `apps/**/styles/**`, `apps/**/public/**`, `apps/**/app/**`, `apps/**/src/**`, `apps/**/pages/**` | 전체 |
| **BE** | Blake | `apps/**/api/**`, `apps/**/app/api/**`, `apps/**/lib/**`, `apps/puppeteer-api/**` | 전체 |
| **PERF** | Chase | `*.config.js`, `*.config.ts`, `vercel.json`, `vercel.ts`, `package.json`, `pnpm-lock.yaml`, `.npmrc`, `.env*`, `Dockerfile`, `**/Dockerfile`, `**/package.json`, `**/*.config.js`, `**/*.config.ts` | 전체 |
| **AI** | Sage | `apps/openrouter-proxy/**` | 전체 |
...
| **OC** | Sam | `.claude/agents/**`, `.claude/commands/**`, `.claude/rules/**`, `.claude/hooks/**` | 전체 |
