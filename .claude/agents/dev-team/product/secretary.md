...
> Thin wrapper - 실제 정의는 `.agent/subagents/dev-team/product/secretary.md`를 읽으세요.

Read [`.agent/subagents/dev-team/product/secretary.md`](../../../../.agent/subagents/dev-team/product/secretary.md) and follow it.
