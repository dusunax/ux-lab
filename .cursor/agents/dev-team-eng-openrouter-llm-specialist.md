...
> Thin wrapper - 실제 정의는 `.agent/subagents/dev-team/eng/openrouter-llm-specialist.md`를 읽으세요.

Read [`.agent/subagents/dev-team/eng/openrouter-llm-specialist.md`](../../.agent/subagents/dev-team/eng/openrouter-llm-specialist.md) and follow it.
