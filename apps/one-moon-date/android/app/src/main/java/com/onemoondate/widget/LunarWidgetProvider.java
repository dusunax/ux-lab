...
/**
 * 음력 위젯 프로바이더
 * 홈 화면에 오늘의 음력 날짜를 표시하는 위젯
 */
public class LunarWidgetProvider extends AppWidgetProvider {

    private static final String ACTION_UPDATE_WIDGET = "com.onemoondate.ACTION_UPDATE_WIDGET";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_UPDATE_WIDGET.equals(intent.getAction()) ||
            ...
            ComponentName thisWidget = new ComponentName(context, LunarWidgetProvider.class);
    ...
    /**
     * 저장된 언어 가져오기
     * AsyncStorage와 SharedPreferences 모두 확인
     */
    ...
    private static int getColorSafely(Context context, int colorResId) {
        try {
            ...
            android.util.Log.e("LunarWidget", "색상 가져오기 실패: " + colorResId, e);
            return 0xFF000000;
        }
    }
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        try {
            ...
            if (lunar == null) {
                android.util.Log.e("LunarWidget", "음력 계산 실패: " + currentYear + "/" + currentMonth + "/" + currentDay);
            ...
            android.util.Log.e("LunarWidget", "위젯 업데이트 실패", e);
        }
    }
    ...
    private void scheduleMidnightUpdate(Context context) {
        ...
        Intent intent = new Intent(context, LunarWidgetProvider.class);
        ...
        try {
            ...
            android.util.Log.w("LunarWidget", "정확한 알람 권한 없음, 일반 알람 사용", e);
            alarmManager.setAndAllowWhileIdle(
                AlarmManager.RTC_WAKEUP,
                midnight.getTimeInMillis(),
                pendingIntent
