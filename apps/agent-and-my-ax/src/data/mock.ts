...
export const agents: AgentItem[] = [
  {
    ...
    resultPreset: createResultPreset('meeting-to-jira', '회의록 → Jira Agent', '김두선'),
    downloads: createDownloads({
      ...
      usageGuide: '회의록 원문을 그대로 붙여넣고, 결정 사항과 담당자가 드러나는 문장을 지우지 않는 것이 가장 좋습니다.',
      visibility: 'company',
      prompt: '회의록을 읽고 결정 사항, 담당자, 마감일, 후속 액션을 업무 티켓 초안으로 정리하세요.',
    }),
  ...
  },
  {
    ...
    resultPreset: createResultPreset('prd-reviewer', 'PRD 리뷰 Agent', '이서연'),
    downloads: createDownloads({
      id: 'prd-reviewer',
      title: 'PRD 리뷰 Agent',
      platform: 'ChatGPT',
      usageGuide: '목표, 포함 범위, 제외 범위, 수용 기준을 한 번에 넣으면 누락된 의사결정을 더 잘 찾습니다.',
      visibility: 'company',
      prompt: 'PRD 초안을 검토해 목표, 범위, 수용 기준, 의존성, Open Question의 빈틈을 리뷰 코멘트로 정리하세요.',
    }),
  ...
  },
  {
    ...
    resultPreset: createResultPreset('sql-explain', 'SQL Explain Agent', '박민준'),
    downloads: createDownloads({
      id: 'sql-explain',
      title: 'SQL Explain Agent',
      platform: 'Gen.AI',
      usageGuide: '쿼리와 함께 테이블 목적, 예상 데이터 규모, 느린 구간을 같이 적으면 성능 리스크 설명이 정확해집니다.',
      visibility: 'team',
      prompt: 'SQL을 단계별로 해석하고 비즈니스 의미, 성능 리스크, 인덱스/집계 비용 확인 포인트를 설명하세요.',
    }),
  ...
  },
  {
    ...
    resultPreset: createResultPreset('voc-cluster', 'VOC 클러스터 Agent', '정하늘'),
    downloads: createDownloads({
      id: 'voc-cluster',
      title: 'VOC 클러스터 Agent',
      platform: 'Document.AI',
      usageGuide: '문의 내용을 줄 단위로 나누고, 날짜나 채널 정보가 있으면 함께 붙여넣으세요.',
      visibility: 'team',
      prompt: 'VOC 목록을 주제별로 묶고 긴급도, 담당 후보, 반복 패턴, 다음 확인 질문을 제안하세요.',
    }),
  ...
  },
  {
    ...
    resultPreset: createResultPreset('chat-summary', 'Google Chat 요약 Agent', '김두선'),
    downloads: createDownloads({
      id: 'chat-summary',
      title: 'Google Chat 요약 Agent',
      platform: 'Agent Builder',
      usageGuide: '스레드 전체를 시간순으로 붙여넣으면 결정/미결정 항목을 더 안정적으로 구분합니다.',
      visibility: 'private',
      prompt: '채팅 스레드에서 합의된 내용, 아직 답이 없는 질문, 공유 가능한 요약문을 분리해 작성하세요.',
    }),
