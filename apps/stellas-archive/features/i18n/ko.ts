export const ko = {
  ...
  missionText: {
    feedLabel: "생명체에 에너지를 전달해 생존 에너지를 회복하세요.",
    feedOptional: "색 변화를 보려면 백색/흑색 주입체를 번갈아 써 보세요.",
  ...
  interfaceText: {
    ...
    mutationStage: "진화 단계",
     species: "종족",
    speciesProfile: "루미나 공통 정보",
    myLuminaData: "내 루미나 데이터",
    metaEmotion: "감정",
    metaState: "상태",
    missionEmpty: "현재 미션이 없습니다.",
    requiredAction: "요구 동작",
    defaultNotice: "관찰하고 에너지를 전달해 색이 변하는 과정을 확인하세요.",
    noToken: "토큰이 부족합니다.",
    ...
    days: "일",
    noEnergy: "에너지가 0입니다. 에너지 전달만 가능합니다.",
    hunger: "배고픔",
    cleanliness: "선명도",
    affection: "친밀도",
    energy: "에너지",
