export const en = {
  ...
  missionText: {
    feedLabel: "Transfer energy to restore the creature's survival energy.",
    feedOptional: "Alternate white and black pulses to observe subtle color reactions.",
  ...
  interfaceText: {
    ...
    rosterSelectTitle: "Select Research Target",
    all: "All",
    active: "Active",
    select: "Select",
    emotion: "Emotion",
    ...
    mutationStage: "Mutation Stage",
     species: "Species",
    speciesProfile: "Lumina Profile",
    myLuminaData: "My Lumina Data",
    metaEmotion: "emotion",
    metaState: "state",
    missionEmpty: "No missions assigned.",
    requiredAction: "Required action",
    defaultNotice: "Observe and transfer energy to watch the color shifts.",
    ...
    days: "days",
    noEnergy: "Energy is depleted. Only Energy Transfer is available.",
    hunger: "Hunger",
