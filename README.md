...
| --- | --- | --- | --- | --- |
| **Smart Screenshot Capture** | 스크린샷 촬영 중 HTML 요소를 숨기는 Chrome 익스텐션 ([소스코드](./extensions/chrome-capture), [chrome Web Store Download](https://chromewebstore.google.com/detail/smart-screenshot-capture/ppfgojhejbonngopillfneiphhienpcj) ) | 2026-08-16 | dusunax | ![Chrome Extension](https://img.shields.io/badge/Chrome%20Extension-4285F4?logo=googlechrome&logoColor=white) ![Manifest v3](https://img.shields.io/badge/Manifest%20v3-34A853?logo=chromatic&logoColor=white) |
